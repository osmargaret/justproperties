<div x-data="{ 
    ...
    <main class="white-header max-w-7xl mx-auto px-4 mt-[90px] mb-12">
        <!-- Breadcrumbs & Header -->
        <div class="mb-6">
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4 h-[400px]">
            <div @click="activeImage = 0; galleryOpen = true" :class="images.length > 1 ? 'md:col-span-3' : 'md:col-span-4'" class="rounded-2xl overflow-hidden relative group cursor-pointer bg-gray-100 h-full">
            ...
            <div class="hidden md:grid grid-rows-2 gap-4 h-full" x-show="images.length > 1">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-emerald-50 sticky top-28">
                    <div class="mb-6">
                        ...
                        <div class="text-4xl font-extrabold text-emerald-600 tracking-tight">{{ $property->currency ?? '₦' }}{{ number_format($property->cost) }}</div>
                    </div>
