...
<div x-data="{ 
    ...
    <!-- HERO SLIDER SECTION h-[600px] md:h-[700px] lg:h-[760px] (Starts from top behind navbar)  -->
    <section class="relative w-full h-[600px] bg-gray-950 overflow-hidden group">
        ...
        <!-- Dark Gradient Overlay (Top dark for navbar visibility, bottom dark for content visibility) -->
        <div class="absolute inset-0 bg-gradient-to-b from-black/80 via-black/20 to-gray-950"></div>
        ...
        <div class="absolute top-20 sm:top-24 left-0 right-0 z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end md:justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                ...
                <button class="w-9 h-9 sm:w-10 sm:h-10 bg-black/50 hover:bg-white hover:text-gray-900 text-white rounded-full flex items-center justify-center backdrop-blur-md border border-white/15 transition shadow-lg cursor-pointer">
        ...
        <!-- Slider Navigation Arrows (z-30 ensures clickability above info panel on mobile/tablet) -->
